// Profesjonalne ikony SVG dla strony KPR Żukowo
// Zastępują emotikony bardziej eleganckimi ikonami
...
export function TrophyIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 3h14a1 1 0 011 1v2a6 6 0 01-3 5.19V13a4 4 0 01-4 4h-2a4 4 0 01-4-4v-1.81A6 6 0 014 6V4a1 1 0 011-1zM4 6h2m12 0h2M9 17v2a1 1 0 001 1h4a1 1 0 001-1v-2" />
    </svg>
  );
}
...
export function SeedlingIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 21V10m0 0c0-2.5 2-5 5-5 0 3-2 5-5 5zm0 0c0-2.5-2-5-5-5 0 3 2 5 5 5z" />
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 10v11" />
    </svg>
  );
}
...
export function HandshakeIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 11l4-4 4 4m-4-4v12M3 17v2a2 2 0 002 2h14a2 2 0 002-2v-2M3 7V5a2 2 0 012-2h14a2 2 0 012 2v2" />
    </svg>
  );
}
