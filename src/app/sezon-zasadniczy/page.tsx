...
import TurniejBanner from "@/components/turniej/TurniejBanner";
import { CalendarIcon, ClockIcon, LocationIcon, TicketIcon } from "@/components/Icons";

export const metadata: Metadata = {
  title: "Sezon zasadniczy 1. Liga | KPR Fit Dieta Żukowo",
  description:
    "Mecze, tabela ligowa i klasyfikacja strzelców KPR Fit Dieta Żukowo w 1. Lidze sezonu 2025/26. Najbliższe spotkania, statystyki, terminarz.",
  alternates: { canonical: "https://kprzukowo.pl/sezon-zasadniczy" },
};
...
export default async function SezonZasadniczy() {
    ...
    <div>
      ...
      <section className="py-16 bg-navy text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-200 mb-4">Tu zaczyna się historia</p>
          <p className="text-gray-300 mb-8">
            Dzieci, rodziny, lokalność – to fundament KPR Żukowo. Każdy mecz to święto dla
            całej społeczności.
          </p>
          <Link
            href="/kibice"
